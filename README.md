...
Skin cancer is one of the most common cancers worldwide, and early detection plays a critical role in successful treatment. This project explores the use of deep learning image classification models to assist in identifying potentially high-risk skin lesions.
...
📁 Project Structure ├── models/ │ ├── cnn_model.keras │ ├── vgg_model.keras │ └── effnet_model.keras ├── app.py # Web application ├── training_notebook.ipynb #effnet_model.keras ├── requirements.txt └── README.md
...
Our project shows that deep learning can effectively assist in skin cancer detection. EfficientNetB0 achieved the best performance for our task, especially in terms of recall.
